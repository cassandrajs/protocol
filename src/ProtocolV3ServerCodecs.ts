...
export class ProtocolV3ServerCodecs implements CodecGroup {
	registerCodecs(registry: CodecGroupRegistry) {
		...
		registry
			...
			.addEncoder(new ProtocolError.Codec(ProtocolConstants.Version.V3))
			.addEncoder(new ProtocolEvent.Codec(ProtocolConstants.Version.V3))
