...
export class ProtocolV4ClientCodecs implements CodecGroup {
	registerCodecs(registry: CodecGroupRegistry) {
		...
		registry
			...
			.addDecoder(new ProtocolError.Codec(ProtocolConstants.Version.V4))
			.addDecoder(new ProtocolEvent.Codec(ProtocolConstants.Version.V4))
