export type Opcode =
	(typeof ProtocolConstants.Opcode)[keyof typeof ProtocolConstants.Opcode]
export type ProtocolVersion =
	(typeof ProtocolConstants.Version)[keyof typeof ProtocolConstants.Version]
...
export class ProtocolConstants {
	...
	static OpcodeToString(opcode: Opcode) {
...
export const OpcodeStrings = Object.fromEntries(
	Object.entries(ProtocolConstants.Opcode).map((val) => [val[1], val[0]])
)
