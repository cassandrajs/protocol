...
export class ProtocolV3ClientCodecs implements CodecGroup {
	registerCodecs(registry: CodecGroupRegistry) {
		...
		registry
			...
			.addDecoder(new ProtocolError.Codec(ProtocolConstants.Version.V3))
			.addDecoder(new ProtocolEvent.Codec(ProtocolConstants.Version.V3))
