...
export class MockBinaryStringElement {
    ...
    size() {
        ...
        switch (this.type) {
            ...
            case MockBinaryStringElement.Type.INET:
                return PrimitiveSizes.sizeOfInet(this.value);
            case MockBinaryStringElement.Type.INETADDR:
                return PrimitiveSizes.sizeOfInetAddr(this.value);
    ...
    toString() {
        const typeName = Object.fromEntries(Object.entries(MockBinaryStringElement.Type).map((x) => [x[1], x[0]]))[this.type];
